        ...
        **Example diagnostics**:
        ...
        while uris_to_wait_for_response or uris_to_wait_for_processing:
            ...
            if method and res_id is not None:
                if self.print_warnings:
                    print(
                        f"WARNING: Received unsupported request from server: {method}. Responding with error."
                    )
                response = {
                    "jsonrpc": "2.0",
                    "id": res_id,
